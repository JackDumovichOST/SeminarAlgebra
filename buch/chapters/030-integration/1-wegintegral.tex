...
Abbildung~\ref{buch:integration:wegintegral:fig:dreiecke}
der Unterschied der Wegintegrale durch ein Gebietsintegral 
ausgedrückt werden.
...
Damit können wir jetzt die Differenz 
\begin{align*}
F_1(b) - F
&=
\int_{\operatorname{Re}a}^{\operatorname{Re}b}
...
f(\psi(y)+is)
\,ds
\intertext{Die Differenzen in den Integranden kann man wieder als
